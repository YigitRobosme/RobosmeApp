...
export default function phoneDetect() {
    ...
    const callFriendTapped = () => {
        Linking.openURL('tel:+905384635730').catch((err) => {
            console.log(err);
        });
    };
        ...
        if (isStart) {
            ...
            callDetector = new CallDetectorManager(
                ...
                (e) => {
                    ...
                    console.log('Permission Denied by User2', e);
                }, {
            ...
            <FlatList
                ...
                renderItem={
                    ({
                        ...
                        <Text style={styles.callLogs} > {JSON.stringify(item)}
                        </Text>
